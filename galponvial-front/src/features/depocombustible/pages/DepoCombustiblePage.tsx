    ...
    <div className="space-y-6">
            ...
            <table className="min-w-full text-sm">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-3 py-3 text-left font-semibold text-gray-600 whitespace-nowrap">Agente</th>
                  <th className="px-3 py-3 text-left font-semibold text-gray-600 whitespace-nowrap">Comprobante</th>
                  <th className="px-3 py-3 text-center font-semibold text-gray-600 whitespace-nowrap">Ingreso Cant.</th>
                  <th className="px-3 py-3 text-center font-semibold text-gray-600 whitespace-nowrap">Egreso Cant.</th>
                  <th className="px-3 py-3 text-center font-semibold text-gray-600 whitespace-nowrap">Stock</th>
                  <th className="px-3 py-3 text-left font-semibold text-gray-600 whitespace-nowrap">Dirección</th>
                  ...
                  <tr key={fila.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-3 py-2">
                      <input
                        ...
                        onChange={(e) => actualizarFila(fila.id, "comprobante", e.target.value)}
                        className="border border-gray-300 rounded-md px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-36"
                      />
                    </td>
                    <td className="px-3 py-2">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <input
                          ...
                          min={0}
                          value={fila.ingreso}
                          onChange={(e) => actualizarFila(fila.id, "ingreso", Math.max(0, Number(e.target.value)))}
                    ...
                    <td className="px-3 py-2">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <input
                          ...
                          min={0}
                          value={fila.egreso}
                          onChange={(e) => actualizarFila(fila.id, "egreso", Math.max(0, Number(e.target.value)))}
                          className="border border-gray-300 rounded-md px-2 py-1.5 text-sm text-center focus:outline-none focus:ring-2 focus:ring-blue-500 w-16"
                        />
                        <button
      ...
      {vista === "visualizar-combustible" && (
        <div className="bg-white rounded-xl shadow border border-gray-200 p-6 text-gray-400 text-sm">
          {/* Próximamente: formulario de Visualizar Combustible */}
      ...
      {vista === "historial-combustible" && (
        <div className="bg-white rounded-xl shadow border border-gray-200 p-6 text-gray-400 text-sm">
          {/* Próximamente: formulario de Historial de Combustible */}
