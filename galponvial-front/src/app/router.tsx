...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: ROUTES.almacen, element: <ModuloProtectedRoute modulo="almacen"><AlmacenPage /></ModuloProtectedRoute> },
      { path: "/almacen/:id", element: <ModuloProtectedRoute modulo="almacen"><ArticuloDetallesPage /></ModuloProtectedRoute> },
      { path: ROUTES.articulosEliminados, element: <ModuloProtectedRoute modulo="almacen"><ArticulosEliminadosPage /></ModuloProtectedRoute> },
      ...
      { path: "/almacen/grupos/:id", element: <ModuloProtectedRoute modulo="almacen"><GrupoDetallesPage /></ModuloProtectedRoute> },
